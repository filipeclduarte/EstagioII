...
A importação de dados mais comum se dá por meio de arquivos `.csv`, utilizando a função `read.csv()`. Contudo, é possível importar arquivos em `.txt` usando a função `read.table()`. 
